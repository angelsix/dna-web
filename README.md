...
page links that could be anywhere in the pages.   Once you start converting your
website to your final server code (cshtml for example) the issues really start.
Now you have 2 separate codes to maintain (static HTML and cshtml).
...
engine listens out for your dnaweb and dnacs files. The path is the
`monitor:`path and is relative to the location of the dna.config file.
